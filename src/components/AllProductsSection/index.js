...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&rating=${rating}&category=${category}&title_search=${titleSearch}`

    console.log('rating -> ', rating, apiUrl)
    const options = {
      headers: {
